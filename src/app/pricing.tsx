...
export default function PricingSection() {
  return (
    <section className="bg-black text-white px-6 sm:px-16 pt-[10px] pb-[100px]">
      <div className="max-w-6xl mx-auto text-center">
      <div className="max-w-6xl mx-auto text-left">
  <h2 className="text-2xl sm:text-4xl font-medium mb-4 md:pl-[110px]">Smart plans for every voyage</h2>
  <p className="text-gray-400 text-sm sm:text-lg font-normal max-w-2xl mt-4 md:pl-[110px]">
    Hear from our marine enthusiasts about how Marine Radar has enhanced their navigation and delivered real-time insights at sea.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:pl-[110px] pt-20">
          {plans.map((plan, idx) => (
            <div
              key={idx}
